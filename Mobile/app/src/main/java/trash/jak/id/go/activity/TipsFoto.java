...
public class TipsFoto extends AppCompatActivity {

    //Web api url
    public static final String DATA_URL = "http://myshaf.com/alif/tipstrash.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager layoutParams = new LinearLayoutManager(TipsFoto.this);
    ...
    private void getData(){
        ...
        final ProgressDialog loading = ProgressDialog.show(TipsFoto.this, "Please wait...","Fetching data...",false,false);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(TipsFoto.this);
    ...
    private void showGrid(JSONArray jsonArray){
        ...
        FragmentFotoAdapter fragmentFotoAdapter = new FragmentFotoAdapter(TipsFoto.this,list);
