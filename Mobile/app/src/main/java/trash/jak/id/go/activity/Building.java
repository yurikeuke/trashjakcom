...
public class Building extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    private SwipeRefreshLayout swp;
    private List<BuildingModel> buildingModelArrayList =new ArrayList<>();
    ConnectionDetector cd;
    Boolean isInternetPresent = false;
    private ProgressDialog mProgressDialog;
    private RecyclerView recyclerView;
    private ConnectionDetector connectionDetector;
    private RecyclerAdapterBuilding mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.item_list_building);
        buildingModelArrayList = new ArrayList<BuildingModel>();
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        LinearLayoutManager layoutParams = new LinearLayoutManager(Building.this, LinearLayoutManager.VERTICAL, false);
        showProgressDialog();
        ...
        getSupportActionBar().setTitle("Perusahaan Pengangkut Sampah");
        requestListBuilding();
        showData();
    }
    ...
    private void requestListBuilding() {
        final ProgressDialog loading = ProgressDialog.show(Building.this, "Please wait...","Fetching data...",false,false);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Building.this);
    ...
    private void showGrid(JSONArray jsonArray){
        ...
        for(int i = 0; i<jsonArray.length(); i++){
            ...
            try {
                ...
                BuildingModel item = new BuildingModel();
        ...
        RecyclerAdapterBuilding fragmentFotoAdapter = new RecyclerAdapterBuilding(Building.this,list);
    ...
    private void showData() {
        mAdapter = new RecyclerAdapterBuilding(Building.this,  buildingModelArrayList);
        recyclerView.setAdapter(mAdapter);

    }
    private void showProgressDialog() {
        if (mProgressDialog == null) {
            mProgressDialog = new ProgressDialog(Building.this); //Here I get an error: The constructor ProgressDialog(PFragment) is undefined
    ...
    public void onRefresh() {
        new Handler().postDelayed(new Runnable() {
            @Override public void run() {
                ...
                cd = new ConnectionDetector(Building.this);
                isInternetPresent = cd.isConnectingToInternet();
                if (isInternetPresent) {
                    Toast.makeText(Building.this, "List Perusahaan", Toast.LENGTH_SHORT).show();
                } else{
                    showAlertDialog(Building.this, getResources().getString(R.string.no_internet1),
    ...
    public void showAlertDialog(Context context, String title, String message,
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(
                new ContextThemeWrapper(Building.this,
