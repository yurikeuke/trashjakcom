...
public class ImJmlahSmpah extends AppCompatActivity {
    ...
    private void fitXY(){
        Display display = ImJmlahSmpah.this.getWindowManager().getDefaultDisplay();
    ...
    private void loadingInternetPic() {
        ...
        Glide.with(this)
                .load("http://myshaf.com/images/Jumlah_Sampah_Terangkut_Per_Hari.png")
